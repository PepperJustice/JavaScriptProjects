...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some (element => element.includes(squareNumber))) {
        //this condition retrieves the html element id that was clicked
        ...
        if (activePlayer === 'X') {
            //if active  plaer is 'X' change it to 'O'
            activePlayer = 'O';
        ...
        //Returning true si needed for our coputersTurn() function to work
        return true;
    }
...
//this function makes your body element temp unclickable
function disableClick() {
    //this makes your body unclickable
...
function drawWinLIne(coordX1, coordY1, coordX2, coordY2) {
    //this line accesses our html canvas elment
    const canvas = document.getElementById('win-lines')
    //this line gives us access to methods and properties to use on canvas
    const c = canvas.getContext('2d');
    //thsi line indicates where the start of a lines x axis is
    let x1 = coordX1,
