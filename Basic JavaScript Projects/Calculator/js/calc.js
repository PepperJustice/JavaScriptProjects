...
const Calculator = {
    ...
    First_Operand: null, 
    //this checs whether or not the second operand has been input
    Wait_Second_Operand: false,
    //this will hold the operator, we set it to null for now
    operator: null,
};

//this modiffies values each time a buttton is clicked
...
function Handle_Operator(Next_Operator) {
    ...
    //when an operator is pressed, we convert the  current number
...
keys.addEventListener('click', (event) => {
    ...
    //ensures  that AC clears the nubmers from the Calculator
